...
import keys
from vk_funk import search_users, get_photo, sort_likes, json_create
from db import engine, Session, write_msg, register_user, add_user, add_user_photos, \
        ...
        if msg_text == "vkinder":
            ...
            # Ищем партнера
                ...
                for i in range(len(result)):
                    ...
                    write_msg(user_id, '1 - Добавить  избранное, 0 - Далее, \nq - выход из поиска')
                    msg_text, user_id = loop_bot()
                    if msg_text == '0':
